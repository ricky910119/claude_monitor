...
class ClaudeHUD:
    def __init__(self):
        ...
        self.status_text = self._make_text(self.content_area, height=6, width=36, padx=15, pady=6)
    ...
    def _set_status(self, text, tag="dim"):
        def _do():
            ...
            lines = text.count("\n") + 1
            self.status_text.config(height=lines)
            self.status_text.pack(anchor="w")
            self._write_widget(self.status_text, [(text, tag)])
